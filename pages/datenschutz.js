...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>Datenschutzerklärung - Wagemann Schweiß-Service</title>
        <meta
          name="description"
          content="Datenschutzerklärung der Website. Erfahren Sie, wie wir Daten erheben und verarbeiten und welche Rechte Sie in Bezug auf Ihre Daten haben."
        />
        <meta
          property="og:title"
          content="Datenschutzerklärung - Wagemann Schweiß-Service"
        />
        <meta
      ...
      <div>
        <div className={styles.container}>
          ...
          <p>
            ...
            „externe Links“). Da wir auf deren Inhalte keinen Einfluss haben,
            kann für die fremden Inhalte keine Gewähr übernommen werden. Für die
            ...
            Sobald uns eine Rechtsverletzung bekannt wird, werden wir den
            jeweiligen Link umgehend entfernen.
          </p>
        </div>
      </div>
    </>
